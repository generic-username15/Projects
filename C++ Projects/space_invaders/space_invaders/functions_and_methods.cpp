...
void Manager::loadGraphics() {
    ...
    sf::Image fire_img;
    fire_img.loadFromFile("graphics\\fire.png");
    static sf::Texture fire;
    fire.loadFromImage(fire_img);
    Fire_enemy::graphics.setTexture(fire);

    sf::Image stone_hp1_img;
    stone_hp1_img.loadFromFile("graphics\\rock_hp1.png");
    static sf::Texture stone_hp1;
    stone_hp1.loadFromImage(stone_hp1_img);
    Stone_enemy::graphics_hp1.setTexture(stone_hp1);

    sf::Image stone_hp2_img;
    stone_hp2_img.loadFromFile("graphics\\rock_hp2.png");
    static sf::Texture stone_hp2;
    stone_hp2.loadFromImage(stone_hp2_img);
    Stone_enemy::graphics_hp2.setTexture(stone_hp2);

    sf::Image stone_hp3_img;
    stone_hp3_img.loadFromFile("graphics\\rock_hp3.png");
    static sf::Texture stone_hp3;
    stone_hp3.loadFromImage(stone_hp3_img);
    Stone_enemy::graphics_hp3.setTexture(stone_hp3);

    sf::Image toxic_img;
    toxic_img.loadFromFile("graphics\\toxic.png");
    static sf::Texture toxic;
    toxic.loadFromImage(toxic_img);
    Toxic_enemy::graphics.setTexture(toxic);

    sf::Image ghost_img;
    ghost_img.loadFromFile("graphics\\ghost.png");
    static sf::Texture ghost;
    ghost.loadFromImage(ghost_img);
    Player::graphics.setTexture(ghost);

    sf::Image plant_img;
    plant_img.loadFromFile("graphics\\plant.png");
    static sf::Texture plant;
    plant.loadFromImage(plant_img);
    Player_projectile::graphics.setTexture(plant);

    sf::Image rock_img;
    rock_img.loadFromFile("graphics\\stone_p.png");
    static sf::Texture rock;
    rock.loadFromImage(rock_img);
    Stone_projectile::graphics.setTexture(rock);

    sf::Image flame_img;
    flame_img.loadFromFile("graphics\\fire_p.png");
    static sf::Texture flame;
    flame.loadFromImage(flame_img);
    Fire_projectile::graphics.setTexture(flame);

    sf::Image chemical_img;
    chemical_img.loadFromFile("graphics\\toxic_p.png");
    static sf::Texture chemical;
    chemical.loadFromImage(chemical_img);
    Toxic_projectile::graphics.setTexture(chemical);

    sf::Image heart_img;
    heart_img.loadFromFile("graphics\\heart.png");
    static sf::Texture heart;
    heart.loadFromImage(heart_img);
...
void audioManager::loadAudio() {
    ...
    shot_b.loadFromFile("audio/shot.ogg");
